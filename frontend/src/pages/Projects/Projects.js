                                ...
                                <div className="card rounded project-card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="ad-btn">
                                            <a className='btn btn-primary' href='https://github.com/AnuragKapoor19/Foodies'>Source Code</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div className="project-content col-md-6 col-lg-5 col-xxl-4 col-sm-12">
                                <div className="card rounded project-card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="ad-btn">
                                            <a className='btn btn-primary' href='https://github.com/AnuragKapoor19/VGossip'>Source Code</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card rounded project-card">
                                    ...
                                    <div className="card-body">
                                        ...
                                        <div className="ad-btn" id='ad3-btn'>
                                            <a className='btn btn-primary' href='https://github.com/AnuragKapoor19/Portfolio'>Source Code</a>
